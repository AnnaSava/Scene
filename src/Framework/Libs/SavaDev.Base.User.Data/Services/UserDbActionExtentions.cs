...
namespace SavaDev.Base.User.Data.Services
{
    public static class UserDbActionExtentions
    {
        ...
        {
            var currentEntity = new TUserEntity();// await dbContext.GetEntityForUpdate<TUserEntity>(model.Id);
        ...
        public static async Task<TUserModel> Delete<TUserEntity, TUserModel>(this IUserManagerAdapter<TUserEntity> adapter,
            ...
            where TUserEntity : BaseUser,new()
        {
            var entity = new TUserEntity();// await dbContext.GetEntityForUpdate<TUserEntity>(id);
        ...
        public static async Task<TUserModel> Restore<TUserEntity, TUserModel>(this IUserManagerAdapter<TUserEntity> adapter,
            ...
            where TUserEntity : BaseUser, new()
        {
            var entity = new TUserEntity();//await dbContext.GetEntityForRestore<TUserEntity>(id);
