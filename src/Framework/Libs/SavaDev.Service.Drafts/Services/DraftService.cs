...
{
    public class DraftService : BaseDraftEntityService<Draft, DraftModel, DraftFilterModel> , IDraftService
    {
        public DraftService(IDraftContext dbContext, IMapper mapper, ILogger<DraftService> logger)
