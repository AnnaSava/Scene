...
namespace SavaDev.Service.Drafts.Services
{
    // TODO Наследие Content, объединить с DraftService
    public class BaseDraftEntityService<TEntity, TModel, TFilterModel> 
        where TEntity : Draft, IEntity<Guid>, IEntityRestorable, new()
        where TFilterModel : BaseFilter, new()
        where TModel: IFormModel, IAnyModel
    {
        protected readonly IMapper _mapper;
        protected readonly IDraftContext _dbContext;
        ...
        public BaseDraftEntityService(IDraftContext dbContext, IMapper mapper, ILogger logger)
        {
