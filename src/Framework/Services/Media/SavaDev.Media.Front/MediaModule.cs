...
namespace Sava.Media
{
    ...
    {
        public static void AddMedia(this IServiceCollection services, IConfiguration config, ModuleSettings moduleSettings)
        {
            services.AddModuleDbContext<MediaContext>(config, moduleSettings);
