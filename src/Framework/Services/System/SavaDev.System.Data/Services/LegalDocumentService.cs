...
{
    public class LegalDocumentService : BaseEntityService<LegalDocument, LegalDocumentModel>, ILegalDocumentService
    {
        ...
        public LegalDocumentService(ISystemContext dbContext, IEnumerable<string> availableCultures, IMapper mapper, ILogger<LegalDocumentService> logger)
            : base(dbContext, mapper, nameof(LegalDocumentService))
        {
