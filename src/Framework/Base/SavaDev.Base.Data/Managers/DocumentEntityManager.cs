...
namespace SavaDev.Base.Data.Managers
{
        ...
        where TFormModel : BaseDocumentFormModel<TKey>, new()
    {
        ...
        protected RestorableEntityManager<TKey, TEntity, TFormModel> entityManager;
        ...
        public DocumentEntityManager(IDbContext dbContext, IEnumerable<string> availableCultures, IMapper mapper, ILogger logger)
        {
            ...
            entityManager = new RestorableEntityManager<TKey, TEntity, TFormModel>(dbContext, mapper, logger);
        }
