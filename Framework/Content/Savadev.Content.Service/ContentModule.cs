...
namespace Savadev.Content
{
    ...
    {
        public static void AddContent(this IServiceCollection services, IConfiguration config, ModuleSettings moduleSettings)
        {
            services.AddModuleDbContext<ContentContext>(config, moduleSettings);
